...
//            int permission = ActivityCompat.checkSelfPermission(DisplayPrimaryUserActivity, permissionName);
//
//            if (permission != PackageManager.PERMISSION_GRANTED) {
//                DisplayPrimaryUserActivity.requestPermissions(
...
//    }
    ...
    public void saveToCsv(LinkedList<InputObject> inputpassword_list,
                           float[] location_values,
                           float[] sensor_values){
